...
public final class ErrorMessages {
    ...
    public static final String RESET_CODE_REQUIRED = "비밀번호 재설정 코드를 입력해 주세요.";
    public static final String NEW_PASSWORD_REQUIRED = "새 비밀번호를 입력해 주세요.";
    ...
    public static final String RESET_CODE_MISMATCH = "재설정 코드가 일치하지 않습니다.";
