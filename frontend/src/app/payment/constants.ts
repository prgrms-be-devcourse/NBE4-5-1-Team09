"use client"; // 혹은 생략 가능 (일반 함수만 정의하므로)

export const PGS = [
  { value: "html5_inicis", label: "웹 표준 이니시스" },
  { value: "kcp", label: "NHN KCP" },
  { value: "kcp_billing", label: "NHN KCP 정기결제" },
  { value: "uplus", label: "LG 유플러스" },
  { value: "jtnet", label: "JTNET" },
  { value: "nice", label: "나이스 정보통신" },
  { value: "kakaopay", label: "신 - 카카오페이" },
  { value: "kakao", label: "구 - LG CNS 카카오페이" },
  { value: "danal", label: "다날 휴대폰 소액결제" },
  { value: "danal_tpay", label: "다날 일반결제" },
  { value: "kicc", label: "한국정보통신" },
  { value: "paypal", label: "페이팔" },
  { value: "mobilians", label: "모빌리언스" },
  { value: "payco", label: "페이코" },
  { value: "settle", label: "세틀뱅크 가상계좌" },
  { value: "naverco", label: "네이버 체크아웃" },
  { value: "naverpay", label: "네이버페이" },
  { value: "smilepay", label: "스마일페이" },
];
